...
export const en = {
  ...
  stage: {
    ...
    detectBpm: 'Detect from audio',
    detectBpmTitle: 'Estimate the tempo from the uploaded music (suggestion only)',
    detecting: 'Detecting…',
    detectBpmNoAudio: 'Upload audio first',
    detectBpmFailed: 'No steady beat found',
    detectedBpm: (bpm: number): string => `Detected ${bpm} BPM`,
